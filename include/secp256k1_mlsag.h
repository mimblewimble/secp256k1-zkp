...
SECP256K1_API int secp256k1_prepare_mlsag(uint8_t *m, uint8_t *sk,
    size_t nOuts, size_t nBlinded, size_t nCols, size_t nRows,
    const uint8_t **pcm_in, const uint8_t **pcm_out, const uint8_t **blinds);

SECP256K1_API int secp256k1_get_keyimage(const secp256k1_context *ctx, uint8_t *ki, const uint8_t *pk, const uint8_t *sk);

SECP256K1_API int secp256k1_generate_mlsag(const secp256k1_context *ctx,
...
SECP256K1_API int secp256k1_verify_mlsag(const secp256k1_context *ctx, const uint8_t *preimage,
